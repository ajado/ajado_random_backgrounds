<?php
namespace Ajado\AjadoRandomBackgrounds\Domain\Repository;
...
/**
 * The repository for BackgroundImages
 */
class BackgroundImageRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
